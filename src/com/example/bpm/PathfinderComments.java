...
public class PathfinderComments extends Activity{
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		pathID = actionPlan.getString("pathID");
        ...
        protected String doInBackground(String... params) {
            ...
            try {
                ...
                if (con == null) {
                    ...
                    String query = "select * from comments where comment_obj_id = '"+pathID+"'";
	...
	public class CommentNow extends AsyncTask<String, String, String> {
		...
		String projID = a3bundle.getString("pathID"); 
        ...
        @Override
        protected void onPostExecute(String r) {
        	Toast.makeText(PathfinderComments.this, r, Toast.LENGTH_SHORT).show();
        	...
        	if (edtComment.equals(""))
                ...
                try {
                    ...
                    if (con == null) {
						...
						String query = "insert into comments(comment_text,comment_type,comment_obj_id,comment_from,comment_date) values('"+tagged+"',3,'"+pathID+"','"+userID+"',GETDATE())";
