...
public class TabbedDirectorReports extends Fragment {
	public static final String TAG = TabbedTandVFragment.class.getSimpleName();
	SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;
    
    public static TabbedDirectorReports newInstance(){
		return new TabbedDirectorReports();
    }
    
	public TabbedDirectorReports() {
