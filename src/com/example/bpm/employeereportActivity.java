...
public class employeereportActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pick_from_date.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
	            ...
	            DatePickerDialog dpd = new DatePickerDialog(employeereportActivity.this, new DatePickerDialog.OnDateSetListener() {
	...
	public void setEmployeeList(){
		try {
        	...
        	if(con == null){
        		...
        		rs = stmt.executeQuery(getdepartment);
        		while(rs.next()){
        			department_id = rs.getInt("department_id");
        			
        		}
        		Toast.makeText(getApplicationContext(), department_id+"", Toast.LENGTH_SHORT).show();
        		if(department_id != 0){
        			String getEmployees = "select user_id, user_fname +' '+ user_lname as full_name " +
        					"from users where user_type = 3 and department_id = "+department_id;
