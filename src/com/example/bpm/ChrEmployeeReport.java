...
public class ChrEmployeeReport extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		pick_from_date.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
	            ...
	            DatePickerDialog dpd = new DatePickerDialog(ChrEmployeeReport.this, new DatePickerDialog.OnDateSetListener() {
