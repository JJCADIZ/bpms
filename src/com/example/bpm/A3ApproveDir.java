...
public class A3ApproveDir extends Activity{
		...
		*/
		...
		addComments.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                Intent A3Comments = new Intent(A3ApproveDir.this, A3Comment.class);
...
public class ApproveA3 extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String r) {
            ...
            Toast.makeText(A3ApproveDir.this, r, Toast.LENGTH_SHORT).show();
            if(isSuccess==true) {
            	approveNow.setVisibility(View.GONE);
        ...
        protected String doInBackground(String... params) {
                try {
                    ...
                    if (con == null) {
                        ...
                        String query = "Update a3team set approved = 1 where user_id = '"+userID+"' AND proj_id = '"+projID+"'";
                        String query2 = "Update a3projects set proj_approved = + 1 where proj_id = '"+projID+"'";
                        PreparedStatement preparedStatement = con.prepareStatement(query);
                        PreparedStatement preparedStatement2 = con.prepareStatement(query2);
                        preparedStatement.executeUpdate();
                        preparedStatement2.executeUpdate();

                        String comp = "select proj_approvers,proj_approved from a3projects where proj_id = '"+projID+"'";
