...
public class TabbedEmployeeReports extends Fragment {
	
	public static final String TAG = TabbedTandVFragment.class.getSimpleName();
	SectionsPagerAdapter mSectionsPagerAdapter;
    ViewPager mViewPager;
    
    public static TabbedEmployeeReports newInstance(){
		return new TabbedEmployeeReports();
    }
    
	public TabbedEmployeeReports() {
	...
	public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            args.putInt(TabbedContentFragment.ARG_SECTION_NUMBER, position + 1);
                ...
                switch(position) {
                case 0:
                  fragment = new OKR_Reports();
                  break;
                case 1:
                  fragment = new A3_Reports();
                  break;
                case 2:
                  fragment = new PatfinderReports();
                  break;
                case 3:
                  fragment = new TVReports();
                  break;
                }
        ...
        public CharSequence getPageTitle(int position) {
            ...
            case 3:
            	return getString(R.string.reports_time_and_volume).toUpperCase(l);
            }
            return null;
        }
    }
