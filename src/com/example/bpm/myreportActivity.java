...
public class myreportActivity extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.tv_reports);
		connectionClass = new ConnectionClass();
		SharedPreferences pref = getApplicationContext().getSharedPreferences("MyPref",Context. MODE_PRIVATE); 
        id = Integer.parseInt(pref.getString("IDD", null));
		type_of_report = (Spinner) findViewById(R.id.typeofreport);
		kind_of_report = (Spinner) findViewById(R.id.kindofreport);
		generate = (Button) findViewById(R.id.tv_generate);
		tv_line_chart = (LineChart) findViewById(R.id.tv_chart);
		scroll = (ScrollView) findViewById(R.id.tv_reports_scroll);
		
		from_text = (TextView) findViewById(R.id.tv_from);
		to_text = (TextView) findViewById(R.id.to);
		pick_from_date = (Button) findViewById(R.id.btn_from);
		pick_from_date.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
	            ...
	            DatePickerDialog dpd = new DatePickerDialog(myreportActivity.this, new DatePickerDialog.OnDateSetListener() {
		...
		pick_to_date = (Button) findViewById(R.id.btn_to);
